    ...
    protected void handleComponentAction(Component c, ActionEvent event) {
        ...
        if(rootContainerName.equals("Main")) {
            ...
            if("TextArea1".equals(c.getName())) {
                onMain_TextArea1Action(c, event);
                return;
            }
            if("TextArea2".equals(c.getName())) {
                onMain_TextArea2Action(c, event);
                return;
            }
        }
    }
      ...
      protected void onMain_TextArea1Action(Component c, ActionEvent event) {
      }

      protected void onMain_TextArea2Action(Component c, ActionEvent event) {
      }
